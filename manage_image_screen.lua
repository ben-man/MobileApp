...
local function onRowRender( event )
  ...
  local filename      = row.params.filename
  ...
  title:setFillColor( titleColor )
	...
	local myImage = display.newImageRect( "resources/img/cards/"..filename, system.DocumentsDirectory, 50, 50 )
